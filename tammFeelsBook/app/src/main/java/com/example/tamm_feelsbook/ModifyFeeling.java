...
public class ModifyFeeling extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FeelsListController.getFeelingList(this).addFeelsListener(new FeelsListener() {
            ...
            public void updateListener() {
                ...
                Collection<Feeling> feels = FeelsListController.getFeelingList(ModifyFeeling.this).getFeelings();
                ...
                modifyAlert.setItems(choices, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (which == 0){ //Add comment ...
                            ...
                            FeelsListController.getFeelingList(ModifyFeeling.this).notifyListeners();
                            ...
                            FeelsListController.getFeelingList(ModifyFeeling.this).deleteFeeling(feel, ModifyFeeling.this);
    ...
    public void clearList(View view){
        ...
        FeelsListController.getFeelingList(this).notifyListeners();
